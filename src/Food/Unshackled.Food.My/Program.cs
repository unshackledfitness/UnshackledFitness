...
using Unshackled.Food.My.Components;
using Unshackled.Food.My.Extensions;
using Unshackled.Food.My.Features;
...
switch (dbConfig.DatabaseType?.ToLower())
{
	case DbConfiguration.MSSQL:
		builder.Services.AddDbContext<FoodDbContext, MsSqlServerDbContext>();
		break;
	case DbConfiguration.MYSQL:
		builder.Services.AddDbContext<FoodDbContext, MySqlServerDbContext>();
		break;
	case DbConfiguration.POSTGRESQL:
		builder.Services.AddDbContext<FoodDbContext, PostgreSqlServerDbContext>();
		break;
	default:
		break;
}
...
app.MapRazorComponents<App>()
	...
	.AddAdditionalAssemblies(
		...
		typeof(Unshackled.Food.My.Client._Imports).Assembly);
