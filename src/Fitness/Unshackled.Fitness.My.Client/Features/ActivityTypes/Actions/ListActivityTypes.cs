...
public class ListActivityTypes
{
	...
	public class Handler : BaseActivityTypeHandler, IRequestHandler<Query, List<ActivityTypeListModel>>
	{
		public Handler(HttpClient httpClient) : base(httpClient) { }

		public async Task<List<ActivityTypeListModel>> Handle(Query request, CancellationToken cancellationToken)
		{
			return await GetResultAsync<List<ActivityTypeListModel>>($"{baseUrl}list") ?? [];
		}
	}
}
