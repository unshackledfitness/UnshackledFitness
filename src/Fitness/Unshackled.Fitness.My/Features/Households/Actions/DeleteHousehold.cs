...
public class DeleteHousehold
{
	...
	public class Handler : BaseHandler, IRequestHandler<Command, CommandResult>
	{
		...
		public async Task<CommandResult> Handle(Command request, CancellationToken cancellationToken)
		{
			...
			string imageDir = string.Format(FitnessGlobals.Paths.HouseholdImageDir, household.Id.Encode());
			...
			try
			{
				...
				await db.MemberMeta
					.Where(x => x.MetaKey == FitnessGlobals.MetaKeys.ActiveHouseholdId && x.MetaValue == householdId.ToString())
