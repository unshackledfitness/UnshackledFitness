...
public class UploadImage
{
	...
	public class Handler : BaseHandler, IRequestHandler<Command, CommandResult<ImageModel>>
	{
		...
		{			
			...
			string relativePath = string.Format(FitnessGlobals.Paths.RecipeImageFile, recipe.HouseholdId.Encode(), recipe.Id.Encode(), fileName);
			...
			imageBytes = imageBytes.ResizeJpegTo(FitnessGlobals.MaxImageWidth, AspectRatios.R16x9.Ratio());
