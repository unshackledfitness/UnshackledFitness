...
public class FormActivityModel : BaseMemberObject
{
	...
	public DistanceUnits TotalDistanceUnit { get; set; } = DistanceUnits.Meter;
	public double? TotalAscent { get; set; }
	public DistanceUnits TotalAscentUnit { get; set; } = DistanceUnits.Meter;
	public double? TotalDescent { get; set; }
	public DistanceUnits TotalDescentUnit { get; set; } = DistanceUnits.Meter;
	...
	public SpeedUnits AverageSpeedUnit { get; set; } = SpeedUnits.MetersPerSecond;
	public double? MaximumSpeed { get; set; }
	public SpeedUnits MaximumSpeedUnit { get; set; } = SpeedUnits.MetersPerSecond;
	public double? MinimumAltitude { get; set; }
	public DistanceUnits MinimumAltitudeUnit { get; set; } = DistanceUnits.Meter;
	public double? MaximumAltitude { get; set; }
	public DistanceUnits MaximumAltitudeUnit { get; set; } = DistanceUnits.Meter;
