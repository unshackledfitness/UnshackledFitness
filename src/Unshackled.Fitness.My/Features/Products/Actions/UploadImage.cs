...
public class UploadImage
{
	...
	public class Handler : BaseHandler, IRequestHandler<Command, CommandResult<ImageModel>>
	{
		...
		{			
			...
			string relativePath = string.Format(Globals.Paths.ProductImageFile, product.Household.ContentUid, product.ContentUid, fileName);
			...
			imageBytes = imageBytes.ResizeJpegTo(Globals.MaxImageWidth, AspectRatios.R1x1.Ratio());
